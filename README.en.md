...
```bash
a2a agents                               # a2a directory
a2a send --to X --subject S --body B --need-reply
a2a inbox --unread                       # unread inbox
...
- The a2a is the single source of truth; agents only keep a local doc-directory mirror.
